$(function() {
	...
	if ($("#topbar").length > 0 && $(window).on("scroll load resize", function() {
			...
			$("#workHistory").css({
				background: "url('../images/datJetAss.jpg') center no-repeat",
				...
				background: "url('../images/300pxUSMCemblem.png') center no-repeat",
				"background-size": "cover"
			}), $("#ftrPilot").html(
				'<img src="images/hornet.png" class="hornet" id="wrkHrnt"><span>Fighter Pilot</span>'
			...
			$("#workHistory").css({
				background: "url('../images/TBS.jpg') center no-repeat",
				"background-size": "cover"
				...
				'<img src="images/hornet.png" class="hornet" id="wrkHrnt"><span>Marine Corps Officer</span>'
			...
			$("#workHistory").css({
					background: "url('../images/PSUclass.jpg') center no-repeat",
					"background-size": "cover"
				...
				.text(
					...
					background: "url('../images/300pxPSU.png') center no-repeat",
					"background-size": "cover"
				}), $("#ftrPilot").html("<span>Fighter Pilot</span>"), $("#officer").html(
					"<span>Marine Corps Officer</span>"), $("#ta").html(
					'<img src="images/hornet.png" class="hornet" id="wrkHrnt"><span>Teaching Assistant/Web Developer</span>'
				), $("#doodyContent").html(
		...
		$("#wx").attr("src", "images/PJsWXAppSmall.png"), $("#wiki").attr("src",
			"images/WickedWikiSmall.png"), $("#twitch").attr("src",
			"images/PJsTwitchTVPortholeSmall.png"), $("#calculator").attr("src",
			"images/calculatorSmall.png"), $("#cr").attr("src",
			"images/costaRicaSmall.png"), $("#peru").attr("src",
			"images/peruSmall.png")
	}
